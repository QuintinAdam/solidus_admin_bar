...
describe 'taxons admin bar' do
  ...
  context "an admin user" do
    ...
    it "can navigate to edit the taxon in the admin" do
      ...
      expect(page).to have_current_path(spree.edit_admin_taxonomy_taxon_path(taxonomy.id, taxon.id), ignore_query: true)
    end
  end
  ...
  it "does not allow a normal user to navigate to the admin" do
    ...
    expect(page).not_to have_content('Edit Taxon')
  end
